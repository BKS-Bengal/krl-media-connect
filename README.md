...
A prototype **Smart Farming Command Centre** sits at `command.html` (linked from the essay nav as Command). It is a high-fidelity operational mock: West Bengal → district → AC → team → agent → farmer → farm 360. All farmer and farm records are synthetic and labelled as prototype. The Media Connect essay is unchanged.
...
- *Hello Evening Kolkata*, page 07, 14 September 2026 — "Focus on better facilities for Farmers in WB" (Asish Basak). Clipping `images/press-clip-hello-kolkata.jpg`, page PDF `press/Hello-Evening-Kolkata-14-Sep-2026-page-7.pdf`.
